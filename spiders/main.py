...
engine = create_engine('mysql+pymysql://root:123456@127.0.0.1/weibo_data?charset=utf8mb4')
...
def main(types=[], page=0):
    ...
    print(articleCategoryFilePath, articleDataFilePath, articleCommentsFilePath)
    print('开始爬取文章数据')
...
def emotion_ratio(articleDataFilePath, articleCommentsFilePath):
    ...
    article_df[['negative_ratio', 'neutral_ratio', 'positive_ratio']] = article_df[
        ['negative_ratio', 'neutral_ratio', 'positive_ratio']].fillna(0)
...
if __name__ == '__main__':
    emotion_ratio(r'data\articleContent_2024-05-31_14-56-24.csv', r'data\articleComments_2024-05-31_14-56-24.csv')
